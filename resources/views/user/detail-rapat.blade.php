<x-layouts.user title="Detail Rapat - RuangTemu">
    @php
    $statusConfig = [
    1 => ['label' => 'Disetujui', 'class' => 'bg-cyan-100 text-cyan-700'],
    2 => ['label' => 'Dibatalkan', 'class' => 'bg-red-100 text-red-700'],
    3 => ['label' => 'Selesai', 'class' => 'bg-gray-200 text-gray-700'],
    ];
    ...
    <div class="flex items-center justify-between mb-6">
        <div class="flex items-center gap-3">
            <a href="{{ url()->previous() }}" class="text-gray-700 hover:text-gray-900">
